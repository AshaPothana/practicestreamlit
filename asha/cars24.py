...
cars_df = pd.read_excel("/Users/91789/Documents/GitHub/practicestreamlit/asha/cars24-car-price.xlsx")
...
def model_pred(fuel_type, transmission_type, engine, seats):
    ## loading the model
    with open("/Users/91789/Documents/GitHub/practicestreamlit/asha/car_pred.py", 'rb') as file:
